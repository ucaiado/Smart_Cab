...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.85\textwidth]{images/steps_takes.png}
\caption{\label{fig:boxplot}Number of Seteps Used to Reached The Destination}
\end{figure}
...
max   &        130.00000 \\
\end{tabular}
\caption{\label{tab:sample}Basic Agent Simulation Statistics}
\end{table}
