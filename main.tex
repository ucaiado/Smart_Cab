...
\caption{\label{fig:hist_basic_agent}Exploration and Exploitation Ratio By Value of $k$}
\end{figure}
...
\caption{\label{fig:hist_basic_agent}On Time Ratio By Value of $k$}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.75\textwidth]{images/cum_reard_by_k.png}
\caption{\label{fig:hist_basic_agent}Average Cumulative Reward By Value of $k$}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.75\textwidth]{images/cum_reard_by_gamma.png}
\caption{\label{fig:hist_basic_agent}Average Cumulative Reward By Value of $\gamma$}
\end{figure}

In the last section, I will use $\gamma = 0.5$ to perform the final compartitions.
